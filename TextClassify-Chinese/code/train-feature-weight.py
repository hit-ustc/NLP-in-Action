...
def loadClassDoc(path, label, docments):
    classWords = dict()
...
classWords = loadClassDoc("../data/sougouC/", label, 200)
features = loadFeature("../feature/SVMFeature.txt")
idf_features = featureIDF(classWords, features, "../feature/df-feature.txt")
TFIDFCal(features, classWords, idf_features, "../train.svm")
